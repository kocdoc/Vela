<template>
  <div class="next-to-sidebar">
    ...
    <form @submit.prevent="register">
      <h1 style="margin-top: -20px; margin-bottom: 30px" class="mb-4 text-4xl font-extrabold leading-none tracking-tight text-[#052A34] md:text-5xl lg:text-6xl dark:text-white">Registrierung</h1>
