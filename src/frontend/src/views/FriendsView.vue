<template>
  <div class="next-to-sidebar">
    ...
    <div class = "bell" @click="openNav">
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" class="ml-1.5 w-12 h-12 place-self-center text-[#052A34] transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white" fill="currentColor">
